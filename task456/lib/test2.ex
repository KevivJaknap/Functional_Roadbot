defmodule FooLock do
  ...
  def master_lock(period) do
    timestamp = :os.system_time(:millisecond)
    GenServer.call(__MODULE__, {:master_lock, period, timestamp})
  end
  ...
  def handle_call({:master_lock, period, timestamp}, _from, state) do
    {:reply, :locked, %__MODULE__{data: :locked, period: period, timestamp: timestamp, lock: true}}
  end
