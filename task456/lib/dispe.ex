...
#         11 => [280, 320]}
#   @lst [7, 6, 11]
#   defstruct cur_left: 0, cur_right: 180, sol: @sol, lst: [], dir: :left, pid: nil
#   def start(lst \\ @lst, dir \\ :right) do
#     pid = ServoKit.init_standard_servo()
#     DispHelper.start(pid)
#     p0(%Disp123{lst: lst, dir: dir, pid: pid})
#   end
...
#       else
#         if a > 0 do
#           cur_right = Integer.mod(pos + 180, 360)
...
#       else
#         if a > 0 do
#           cur_left = Integer.mod(pos + 180, 360)
...
#   def p8(state, a) when a > 180 do
#     rotate(360 - a, -1, state)
#   end
